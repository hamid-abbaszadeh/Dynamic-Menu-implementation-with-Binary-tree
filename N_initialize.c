...
{
	memset(str, 0, size);
	/*showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "readString", "1111111 %d", (data));
	showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "readString", "1111111 %d", strlen(data->value.text.string));
	showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "readString", "1111111 %d", (data->value.text.whitespace));

	showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "readString", "1111111 %d", (data));
	showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "readString", "1111111 %d", stringlen(data->value.text.string));
	showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "readString", "1111111 %d", (data->value.text.whitespace));
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", data->value.text.string[0]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", data->value.text.string[1]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", data->value.text.string[2]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", data->value.text.string[3]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", data->value.text.string[4]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", data->value.text.string[5]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", data->value.text.string[6]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", data->value.text.string[7]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", data->value.text.string[8]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", data->value.text.string[9]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", data->value.text.string[10]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", data->value.text.string[11]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", data->value.text.string[12]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", data->value.text.string[13]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", data->value.text.string[14]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", data->value.text.string[15]);*/

	if (strlen(data->value.text.string) <= size)
	{
		strncat(str, data->value.text.string, size - strlen(str));
	}
	/*showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", str[0]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", str[1]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", str[2]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", str[3]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", str[4]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", str[5]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", str[6]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", str[7]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", str[8]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", str[9]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", str[10]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", str[11]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", str[12]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", str[13]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", str[14]);
	showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "str=%d", str[15]);*/
	data = data->next;
...
//
//struct xmlInfo reader(uint8 title[20])
//{
//	
//	int32               fileId = 0;
//	mxml_node_t*        node = NULL;
...
//	int num = 0;
//	xmlFile file;
//	struct xmlInfo xmlinfo;
//	memset(var, NULL, sizeof(var));
//	if (retValue = fileSize("f:menu.xml", &sizeOfFile) != SUCCESS)
//	{
//		showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "ret= %d", retValue);
//		//return FALSE;
...
//	showLog(ALL_POS, __FILE__, __LINE__, TRACE, "", "Parsing xml start");
//
//	switchIndex = mxmlIndexNew(tree, "MENU_CARD_ROOT", NULL);
//	node = mxmlIndexEnum(switchIndex);
//
//
//	
//	{
//		data = mxmlFindElement(node, node, title, NULL, NULL, MXML_DESCEND);
//		showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "hhhhhhhhhhhh");
//
//		if (data != NULL)
//		{
//			showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "jjjjjjjjjjjjjjj");
//
//			if (data->child != NULL)
//			{
//				readString(var, data->child, 30);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[0]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[1]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[2]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[3]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[4]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[5]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[6]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[7]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[8]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[9]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[10]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[11]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[12]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[13]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[14]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[15]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[16]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[17]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[18]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[19]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[20]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[21]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[22]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[23]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[24]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[25]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[26]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[27]);
//				showLog(JUST_VERIFONE, __FILE__, __LINE__, DEBUG, "", "varrrr=%d", var[28]);
//				strcpy(menu[0], convert_PersianUtf8_To_Cp1256( var));
//				
//				//var1 = mxmlElementGetAttr(data, "type");
//				showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "data->value.element.name=%s", data->value.element.name);
//				showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "data->value.element.name=%d", data->value.element.num_attrs);
//				showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "data->value.element.name=%s", data->value.element.attrs[0].name);
//				showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "data->value.element.name=%s", data->value.element.attrs[0].value);
//
//				//for (num = 0; num < data->value.element.num_attrs; num++)
//				{							
//					//strcpy(file.xml[num], data->value.element.attrs[num].value);
//					//showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "xml[i]=%s", file.xml[num]);
//					
//						strcpy(xmlinfo.parentMenuIndex, data->value.element.attrs[0].value);
//						strcpy(xmlinfo.language, data->value.element.attrs[1].value);
//						strcpy(xmlinfo.timeOut, data->value.element.attrs[2].value);
//						strcpy(xmlinfo.align, data->value.element.attrs[3].value);
//						strcpy(xmlinfo.color, data->value.element.attrs[4].value);
//						strcpy(xmlinfo.visible, data->value.element.attrs[5].value);
//						strcpy(xmlinfo.checkPass, data->value.element.attrs[6].value);
//						strcpy(xmlinfo.title, convert_PersianUtf8_To_Cp1256( data->value.element.attrs[7].value));
//						strcpy(xmlinfo.size, data->value.element.attrs[8].value);
//
//
//				}
//
...
//
//
//				//showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "nullll1 ");
//				//if (data->child->value.element.name == NULL)
//				//	showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "nullll2 ");
//				//else
//				//{
//				//	showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "data->child->value.element.name=%s", data->child->value.element.name);
//				//	showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "data->child->value.element.name=%s", data->child->value.element.attrs[0].name);
//				//	showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "data->child->value.element.name=%s", data->child->value.element.attrs[0].value);
//
//				//}
//			
//			}
...
//		*/
//		showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "node->value.element.name=%s", node->value.element.name);
//
//		
//		/*
...
//	* Loop until we find a matching element...
//	*/
//	showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "yyyyyyyyyyyyyy");
//	while (node != NULL)
//	{
//		/*
//		* See if this node matches...
//		*/
//		showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "gggggggg");
//		showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "node->type=%s", node->value.element.name);
//
//
//		if (
...
//			*/
//			showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "ccccccc1");
//			showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "ccccccc=%s",node->value.element.name);
//			showLog(ALL_POS, __FILE__, __LINE__, DEBUG, "", "ccccccc2");
//
//			if (!attr)
...
//	while (node != NULL)
	...
	//	data = mxmlFind(tree, tree, "MENU_CARD_IRANCELL_20000", NULL, NULL, MXML_DESCEND);
